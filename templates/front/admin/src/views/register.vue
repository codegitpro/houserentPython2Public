<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于Django的智能租房系统的设计与实现注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='zuke'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='fangzhu'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='fangzhu'" class="input-group">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`zuke` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
      ...
      if(`fangzhu` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
