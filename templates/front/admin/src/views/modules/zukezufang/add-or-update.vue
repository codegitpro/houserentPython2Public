<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租期" prop="zuqi">
          <el-input v-model="ruleForm.zuqi"
              placeholder="租期" clearable  :readonly="ro.zuqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租期" prop="zuqi">
              <el-input v-model="ruleForm.zuqi"
                placeholder="租期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="租房原因" prop="zufangyuanyin">
                <editor
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zufangyuanyin"
                    class="editor"
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zufangyuanyin" label="租房原因" prop="zufangyuanyin">
                    <span v-html="ruleForm.zufangyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  computed: {
    ...
    zongjia:{
      get: function () {
        return 1*this.ruleForm.zujin*this.ruleForm.zuqi
      }
    },

  },
  created() {
	this.ruleForm.zufangshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjia = true;
          ...
          if(o=='zufangyuanyin'){
            this.ruleForm.zufangyuanyin = obj[o];
	    this.ro.zufangyuanyin = true;
            continue;
          }
          if(o=='zufangshijian'){
	...
	this.ruleForm.zufangyuanyin = this.ruleForm.zufangyuanyin.replace(reg,'../../../housePython2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					 ...
					 this.$http({
					   url: `zukezufang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zukezufangCrossAddOrUpdateFlag = false;
						 this.parent.search();
